      ...
      <Container maxW={'5xl'}>
        <Stack
          ...
          <Heading
            ...
            <Text as={'span'} className="u-stroke" color={'#181C27'}>
              made easy
            </Text>
          </Heading>
          <Text color={'gray.500'} maxW={'2xl'}>
            An open-source resume builder with various templates tailored to help make your resume standout to recruiters and aid job search.
          </Text>
